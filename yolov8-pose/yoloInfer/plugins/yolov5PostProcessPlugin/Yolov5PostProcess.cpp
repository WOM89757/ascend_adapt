...
void Yolov5PostProcess::ConstructBoxFromOutput(float *output, size_t offset, std::vector<ObjectInfo> &objectInfo,
...
void Yolov5PostProcess::LogObjectInfo(std::vector<std::vector<ObjectInfo>> &objectInfos)
{
...
std::shared_ptr<MxBase::Yolov5PostProcess> GetObjectInstance()
{
    ...
    auto instance = std::make_shared<MxBase::Yolov5PostProcess>();
